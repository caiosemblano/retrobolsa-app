  ...
  assets: [
    {
      ...
      sector: 'Energia',
      indicators: { pl: 8.0, lvp: 1.5, lucroPositivo: true, cagrLucro: 12, cagrReceita: 8, margemEbitda: 25 },
    },
    {
      id: 'asset-2',
      type: 'stock',
      ...
      sector: 'Financeiro',
      indicators: { pl: 12.5, lvp: 2.1, lucroPositivo: true, cagrLucro: 15, cagrReceita: 10, margemEbitda: 30 },
    },
    {
      id: 'asset-3',
      type: 'stock',
      ...
      sector: 'Varejo',
      indicators: { pl: 15.2, lvp: 3.5, lucroPositivo: false, cagrLucro: -5, cagrReceita: 2, margemEbitda: 8 },
    },
    {
      id: 'asset-4',
      type: 'stock',
      ...
      sector: 'Tecnologia',
      indicators: { pl: 22.0, lvp: 5.0, lucroPositivo: true, cagrLucro: 25, cagrReceita: 30, margemEbitda: 15 },
    },
    {
      id: 'asset-5',
      type: 'stock',
      ...
      sector: 'Commodities',
      indicators: { pl: 6.5, lvp: 1.1, lucroPositivo: true, cagrLucro: 8, cagrReceita: 12, margemEbitda: 35 },
    },
    {
      id: 'asset-6',
      type: 'bond',
